...
public class Get03 {
   ...
   */
    ...
    public void get03() {
        ...
        //Send the request and het the response                                        //request gönder respponse 'ı al
        Response response = given().get(url);
        response.prettyPrint();                                                        //response ı görürüz.


        //Do assertion
        //1. YOL:
        response.then().statusCode(200)                                             //"then" kullanmak bundan sonra assertion yapilacagi anlamına gelir
                .contentType("application/json")
                .body("userId",equalTo(2))                                 //"userId" is 2
                .body("title",equalTo("et itaque necessitatibus maxime molestiae qui quas velit"))  //title is "et itaq.."
