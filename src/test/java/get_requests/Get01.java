...
public class Get01 {
    ...
    public void get01() {
        ...
        response.then().contentType("application/json");  //Content Type should be "application/json"
        response.then().statusLine("HTTP/1.1 200 OK");   //Status Line should be "HTTP/1.1 200 OK"
    }
